            ...
            return (
              <>
                <div className="col-md-4" key={product.id}>
                  <Link className="anchor" to={`/productdetails/${product.id}`} >
                  <div className="card cardDetails2 shadow h-60 text-center p-0 mt-4">
                    ...
                    <div className="card-body">
                      ...
                      <p className="card-text lead fw-bold text-success ">${product.price}</p>
                      <a href="#" className="btn btn-outline-primary fw-500 ff-poppins">
                        Add to Cart
                      </a>
                    </div>
                  </div>
      ...
      <div className="container my-8 py-4 bg-warm">
        <div className="row">
          <div className="col-12 mb-10">
            <h1 className="display-6 fw-bolder text-center text-success">What we offer</h1>
          </div>
        </div>
